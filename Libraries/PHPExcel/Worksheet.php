...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
	...
	/**
	 * Установите значение ячейки, используя числовые координаты ячейки
	 *
	 * @param   string  $pColumn     Числовая координата столбца ячейки (A = 0)
	 * @param   string  $pRow        Числовая координата строки ячейки
	 * @param   mixed   $pValue      Значение ячейки
	 * @param   bool    $returnCell  Вернуть лист (false, по умолчанию) или ячейку (true)
	 *
	 * @return PHPExcel_Worksheet|PHPExcel_Cell    В зависимости от последнего указанного параметра
	 * @throws PHPExcel_Exception
	 * @since 3.9
	 */
